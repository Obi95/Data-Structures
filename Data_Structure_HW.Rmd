...
my_vector <- c(10,19,4, -2, -6, 0, 12000000)
sort(my_vector)
...
```{r}
student_grades <- c(94, 96, 98, 75, 82)
...
matrix1 <- matrix(first_vector, nrow = 3)

matrix2 <- matrix(second_vector, nrow = 3)
...
# Location for number 5 based on index in the 2nd matrix
